...
const AddVideo = ({ token }) => {
    ...
    useEffect(() => {
        ...
        const fetchProducts = async () => {
            try {
                // If it's a seller, maybe they should only fetch their own products. Using list for simplicity.
                const res = await axios.get(`${backendUrl}/api/product/list`, { headers: { Authorization: `Bearer ${token}` } });
                if (res.data.success) {
