...
const Product = () => {
  ...
  const displayRating = productData?.averageRating || reviewData.stats.averageRating || 4.8;
    ...
    <div className='border-t-2 pt-10 transition-opacity ease-in duration-500 opacity-100 pb-16'>
      ...
      <div className='flex gap-12 sm:gap-12 flex-col sm:flex-row'>
        ...
        <div className='flex-1'>
          ...
          <div className='my-6'>
            <div className='flex items-center justify-between mb-3'>
              ...
              <button
                ...
                className='text-xs font-bold text-black hover:text-blue-600 underline flex items-center gap-1 transition-colors'
              >
          ...
          {/* Compare & Extra Info */}
          <div className='mt-4 flex items-center justify-between pt-4 border-t border-gray-100 text-xs'>
            <button
              onClick={() => addToCompare(productData)}
              className={`font-semibold px-3 py-1.5 rounded-lg border transition-colors flex items-center gap-1.5 ${
                inCompare ? 'bg-emerald-50 text-emerald-700 border-emerald-200' : 'bg-gray-50 text-gray-700 border-gray-200 hover:bg-gray-100'
              }`}
            >
              ⚖️ {inCompare ? 'In Compare List' : 'Add to Compare Matrix'}
            </button>
