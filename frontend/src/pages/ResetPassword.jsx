...
const ResetPassword = () => {
    ...
    return (
        <div className='min-h-[80vh] flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden'>
            ...
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-lg h-full max-h-[500px] bg-gradient-to-tr from-blue-200/40 via-indigo-200/40 to-purple-200/40 blur-3xl -z-10 rounded-full mix-blend-multiply opacity-70"></div>
            ...
            <div className='bg-white/80 backdrop-blur-xl p-8 sm:p-10 rounded-[2rem] shadow-[0_8px_40px_rgb(0,0,0,0.06)] border border-white max-w-[440px] w-full relative z-10'>
                ...
                <div className='mt-8 text-center'>
                    <button onClick={() => navigate('/login')} className='text-sm font-medium text-gray-500 hover:text-indigo-600 transition-colors inline-flex items-center gap-1.5'>
